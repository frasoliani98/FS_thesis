...
import pandas as pd
import itertools
from important_functions import run_EAD_IKr, detect_EAD, baseline_run, plot_GA, baseline_EAD
import itertools
...
fig.suptitle(f'Results IKr Block 100%', fontsize=14)
...
t1,v1 = run_EAD_IKr(ind_1, block, IC=None)
...
t2,v2 = run_EAD_IKr(ind_2, block, IC=None)
...
t3,v3 = run_EAD_IKr(ind_3, block, IC=None)
...
t4,v4 = run_EAD_IKr(ind_4, block, IC=None)
...
t5,v5 = run_EAD_IKr(ind_5, block, IC=None)
...
t6,v6 = run_EAD_IKr(ind_6, block, IC=None)
...
t7,v7 = run_EAD_IKr(ind_7, block, IC=None)
...
t8,v8 = run_EAD_IKr(ind_8, block, IC=None)
