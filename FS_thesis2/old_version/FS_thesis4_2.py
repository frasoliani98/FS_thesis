#%%
#FS_thesis4: main changes
# 1) add new parameters changes in the feature_targets
# 2) update the function get_ead_error in order to evaluate the errors also for the new parameters (?) non la uso
# 3) little error 1e-5
# 4) computation of EADs whith run_EAD and detect_EAD
...
def get_feature_errors(ind, IC):
    ...
    ap_features['cat_amp'] = cat_amp*1e-5
...
#%%
def main():
    all_individuals = start_ga(pop_size=50, max_generations=40)
