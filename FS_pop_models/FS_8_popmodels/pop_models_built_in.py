...
eads_f_up = [(i/5)*100 for i in eads_final_up]
eads_f_down = [(i/5)*100 for i in eads_final_down]
eads_f_ind = [(i/5)*100 for i in eads_final_ind]
...
ax.set_xlabel('ICaL Enhancement [%]', fontsize = 14)
