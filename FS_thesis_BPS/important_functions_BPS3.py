...
def run_EAD(ind):
    ...
    mod['multipliers']['i_cal_pca_multiplier'].set_rhs(1.4129*ind[0]['i_cal_pca_multiplier'])
    mod['multipliers']['i_to_multiplier'].set_rhs(0.4533)
    mod['multipliers']['i_kr_multiplier'].set_rhs(0.8998*ind[0]['i_kr_multiplier'])
    ...
    mod['IKr']['D'].set_state_value(0)
    mod['IKr']['Kmax'].set_rhs(0)
    mod['IKr']['Ku'].set_rhs(0)
    mod['IKr']['Vhalf'].set_rhs(1)
    mod['IKr']['halfmax'].set_rhs(1)
    mod['extracellular']['cao'].set_rhs(1.8)
    mod['extracellular']['ko'].set_rhs(4)
    mod['extracellular']['nao'].set_rhs(144)

    mod['multipliers']['i_na_multiplier'].set_rhs(1)
    mod['multipliers']['i_nal_multiplier'].set_rhs(1)
    #mod['multipliers']['i_cal_pca_multiplier'].set_rhs(ind[0]['i_cal_pca_multiplier'])
    mod['multipliers']['i_to_multiplier'].set_rhs(1)
    #mod['multipliers']['i_kr_multiplier'].set_rhs(ind[0]['i_kr_multiplier'])
    mod['multipliers']['i_ks_multiplier'].set_rhs(1)
    mod['multipliers']['i_k1_multiplier'].set_rhs(1)
    mod['multipliers']['i_NCX_multiplier'].set_rhs(1)
    mod['multipliers']['i_nak_multiplier'].set_rhs(1)
    mod['multipliers']['jrel_multiplier'].set_rhs(1)
