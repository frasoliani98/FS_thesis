...
# Baseline
ind_b = pd.read_excel('FS_IKr_block.xlsx', sheet_name='Sheet1')
...
# IND1
ind_1 = pd.read_excel('FS_IKr_block.xlsx', sheet_name='Sheet1')
...
# IND2
ind_2 = pd.read_excel('FS_IKr_block.xlsx', sheet_name='Sheet1')
...
# IND3
ind_3 = pd.read_excel('FS_IKr_block.xlsx', sheet_name='Sheet1')
...
# IND4
ind_4 = pd.read_excel('FS_IKr_block.xlsx', sheet_name='Sheet1')
...
# IND5
ind_5 = pd.read_excel('FS_IKr_block.xlsx', sheet_name='Sheet1')
...
# IND6
ind_6 = pd.read_excel('FS_IKr_block.xlsx', sheet_name='Sheet1')
...
# IND7
ind_7 = pd.read_excel('FS_IKr_block.xlsx', sheet_name='Sheet1')
...
# IND8
ind_8 = pd.read_excel('FS_IKr_block.xlsx', sheet_name='Sheet1')
