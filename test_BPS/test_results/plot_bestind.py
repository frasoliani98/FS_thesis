...
'''
# Best Ind Plot 1
ind_1 = pd.read_excel('Best_ind_noCa_morph5.xlsx')
...
# Best Ind Plot 2
ind_2 = pd.read_excel('Best_ind_tor2.xlsx')
...
# Best Ind Plot 3
ind_3 = pd.read_excel('Best_ind_tor3.xlsx')
...
# Best Ind Plot
ind_4 = pd.read_excel('Best_ind_tor4.xlsx')
...
# Best Ind Plot 5
ind_5 = pd.read_excel('Best_ind_tor5.xlsx')
...
# Best Ind Plot 6
ind_6 = pd.read_excel('Best_ind_tor6.xlsx')
...
# Best Ind Plot
ind_7 = pd.read_excel('Best_ind_tor7.xlsx')
...
# Best Ind Plot 8
ind_8 = pd.read_excel('Best_ind_noCa.xlsx')
...
ax.plot(tbps, vbps, 'm--', label = 'BPS Baseline')
'''
...
ax.plot(timetor, v90, 'y', label = 'v 90 tor-ord')
